  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <br />
        <br />
        "...capitalistic mode of production in its historical connection and its
        inevitableness during a particular historical period, and therefore,
        also, to present its inevitable downfall; and >to lay bare its essential
        character, which was still a secret. This was done by the discovery of
        *surplus[ producer and consumer]-value*."
        <br />
        <br />
